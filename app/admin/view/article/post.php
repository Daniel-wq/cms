...
<block name="content">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            <label for="inputID" class=" control-label">微信关键词</label>
            <div class="">
                <input type="text" name="wechat_keywords" id="inputID" class="form-control" value="{{$model['wechat_keywords']}}" title="" required="required">
            </div>
        </div>
