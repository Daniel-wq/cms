...
<block name="content">
    ...
    <ul class="nav nav-tabs" role="tablist">
		...
		<li class="active"><a href="{{u('post')}}">栏目添加/编辑</a></li>
	</ul>
	...
	<form action="" method="post">
        ...
        <div class="form-group">
            <label class="checkbox-inline">
                <input type="checkbox" name="iscover" value="1" <if value="$model['iscover']">checked</if> > 是否为封面栏目
            </label>
        </div>
