...
<head>
	...
	<script>
        //HDJS组件需要的配置
        hdjs = {
            'base': 'http://www.houdunwang.com/node_modules/hdjs',
            'uploader': 'http://www.houdunwang.com?s=component/upload/uploader&siteid=11',
            'filesLists': 'http://www.houdunwang.com?s=component/upload/filesLists&siteid=11',
	...
	<script src="http://www.houdunwang.com/node_modules/hdjs/app/util.js"></script>
	<script src="http://www.houdunwang.com/node_modules/hdjs/require.js"></script>
	<script src="http://www.houdunwang.com/node_modules/hdjs/config.js"></script>
	<script src="http://www.houdunwang.com/resource/js/hdcms.js"></script>
	<link href="http://www.houdunwang.com/resource/css/hdcms.css" rel="stylesheet">
	<script>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
							...
							mazhenyu                            <span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
			...
			<div class="panel panel-default">
				...
				<ul class="list-group menus">
					<li class="list-group-item" id="3">
						...
						<a href="?s=site/rule/lists&m=basic&siteid=11&mark=platform&mi=3&mt="
						   class="quickMenuLink">
							文字回复                                            </a>
					</li>
					<li class="list-group-item" id="30">
						...
						<a href="?s=site/rule/lists&m=news&siteid=11&mark=platform&mi=30&mt="
						   class="quickMenuLink">
							图文回复                                            </a>
					</li>
					<li class="list-group-item" id="55">
						<a href="?m=special&action=controller/site/post&siteid=11&mark=platform&mi=55&mt="
						   class="quickMenuLink">
							系统回复                                            </a>
					</li>
				</ul>
				...
				<ul class="list-group menus">
					<li class="list-group-item" id="86">
						<a href="?m=button&action=controller/site/lists&siteid=11&mark=platform&mi=86&mt="
						   class="quickMenuLink">
							微信菜单                                            </a>
					</li>
				</ul>
				<div class="panel-heading">
					<h4 class="panel-title">微信素材</h4>
					<a class="panel-collapse" data-toggle="collapse" href="javascript:;">
						<i class="fa fa-chevron-circle-down"></i>
					</a>
				</div>
				<ul class="list-group menus">
					<li class="list-group-item" id="88">
						<a href="?m=material&action=controller/site/image&siteid=11&mark=platform&mi=88&mt="
						   class="quickMenuLink">
							素材&群发                                            </a>
					</li>
				</ul>
